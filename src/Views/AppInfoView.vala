        ...
        construct {
            ...
            realize.connect (() => {
                ...
                load_more_content(screenshot_files);
                    ...
                    int resize_rate_limit = 0;
                    get_toplevel ().size_allocate.connect (() => {
                        resize_rate_limit ++;
                        var new_top_level_width = get_toplevel ().get_allocated_width ();
                        if ((new_top_level_width - top_level_width).abs() > 20 || resize_rate_limit >= 10) {
                            top_level_width = new_top_level_width;
